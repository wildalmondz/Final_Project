  ...
  playColors(player.asString());
    ...
    function playColors() {
        ...
        document.addEventListener("drop", function (event) {
            ...
            if ((event.target.id === '') || (event.target.id === 'Blue') || (event.target.id === 'Red')
          || (event.target.id === 'Green') || (event.target.id === 'Orange')) {
                ...
                console.log(curPlayer + " dropped [" + data + "] at: [" + event.target.id + "]" + colorElements.length);
